namespace DevExpressReports.Reports.FeedFormulation.Nutrient.RationResult_Nut_Diff
{
    partial class RationResult_Nut_Diff
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(RationResult_Nut_Diff));
            ...
            this.UnitCost = new DevExpress.XtraReports.UI.CalculatedField();
            this.xrControlStyle1 = new DevExpress.XtraReports.UI.XRControlStyle();
            this.Per = new DevExpress.XtraReports.UI.CalculatedField();
            this.QuantityValue = new DevExpress.XtraReports.UI.CalculatedField();
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[NutrientName1]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "Iif(?IsBais, [Quantity1], [Quantity_DM1])\n")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Visible", "?IsShowDifference"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')\n")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[NutrientName2]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "Iif(?IsBais, [Quantity2], [Quantity_DM2])\n"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')\n")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Visible", "[?IsShowCost]\n"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[TotalCost] / [TotalQtn]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Visible", "?IsShowDM or ?IsShowDifference")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "Iif(?IsRTL, \'حقوق النسخ 2003-2025 فيت سوفت - جميع الحقوق محفوظة\', \'Copyright @ 20" +
    ...
    "] / 1000, \'F3\') + \' Tons) \', \'\'\n   \n)\n";
            ...
            // UnitCost_CF
            // 
            this.UnitCost_CF.DataMember = "SR_FM_RationResult_Nut_MultiColumn";
            this.UnitCost_CF.Expression = "ToDecimal([TotalCost] / [TotalQtn])\n";
            this.UnitCost_CF.Name = "UnitCost_CF";
            // 
            // CopyRight
            // 
            this.CopyRight.DataMember = "SR_FM_RationResult_Nut_MultiColumn";
    ...
    "03-2025 VetSoft Office, All rights reserved\')\n";
            ...
            // Test
            // 
            this.Test.DataMember = "SR_FM_RationResult_Nut_MultiColumn";
            this.Test.Expression = "Iif(?IsRTL, \'حقوق النسخ 2003-2025 فيت سوفت - جميع الحقوق محفوظة\', \'Copyright @ 20" +
    "03-2025 VetSoft Office, All rights reserved\')\n";
            this.Test.Name = "Test";
            // 
            // UnitCost
            // 
            this.UnitCost.DataMember = "SR_FM_RationResult_Nut_MultiColumn";
            this.UnitCost.Expression = "[TotalCost] / [TotalQtn]\n";
            ...
            // Per
            // 
            this.Per.DataMember = "SR_FM_RationResult_Nut_MultiColumn";
            this.Per.Expression = "Iif([Quantity2] > 0,\n    [Diff2] * 100 / [Quantity2],\n    0\n)\n";
            this.Per.Name = "Per";
            // 
            // QuantityValue
            // 
            this.QuantityValue.DataMember = "SR_FM_RationResult_Nut_MultiColumn";
            this.QuantityValue.Expression = "Iif(?IsShowDM, [Quantity_DM1], [Quantity1])\n";
            ...
            new DevExpress.XtraReports.UI.GroupField("RationName", DevExpress.XtraReports.UI.XRColumnSortOrder.Ascending)});
            ...
            this.dsFinance1});
            this.DataMember = "SR_FM_RationResult_Nut_MultiColumn";
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.GroupHeader2, "Default", "HeightF", 92.70832F),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.pageInfoCurrentDate, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(0F, 0.9167989F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.pageInfoCurrentDate, "Default", "SizeF", new System.Drawing.SizeF(204.12F, 19.0832F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.pageInfoPageNoOfTotal, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(977.6702F, 0F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.srReportHeader, "Default", "SizeF", new System.Drawing.SizeF(807F, 23.54166F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.srReportNotes, "Default", "SizeF", new System.Drawing.SizeF(806.9983F, 24.24995F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.srReportSignature, "Default", "SizeF", new System.Drawing.SizeF(806.9983F, 22.16662F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.srReportSignature_PageFooter, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(0.003115336F, 0F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.SubBand1, "Default", "HeightF", 24.24995F),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.SubBand2, "Default", "HeightF", 29.79167F),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.SubBand3, "Default", "HeightF", 20F),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.SubBand4, "Default", "HeightF", 21.08339F),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.SubBand5, "Default", "HeightF", 22.16662F),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel1, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(9.998091F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel1, "Default", "SizeF", new System.Drawing.SizeF(473.78F, 23F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel13, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(9.998091F, 69.00004F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel13, "Default", "SizeF", new System.Drawing.SizeF(282.7101F, 23F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel14, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(628.0867F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel14, "Default", "SizeF", new System.Drawing.SizeF(164.9124F, 23F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel14, "Default", "Text", "Total Cost: [TotalCost!N2]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel14, "ar", "Text", "التكلفة الكلية: [TotalCost!N2]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel14, "Default", "Visible", true),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel16, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(699.1231F, 23F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel16, "Default", "SizeF", new System.Drawing.SizeF(75.12622F, 23F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel16, "Default", "Text", ""),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel16, "ar", "Text", "وحدة التكلفة: [UnitCost_CF!N2]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel16, "Default", "TextFormatString", "{0:N2}"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel2, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(9.999068F, 23F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel2, "Default", "SizeF", new System.Drawing.SizeF(194.1219F, 23F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel2, "Default", "Text", "Total Quantity (KG): [TotalQtn!N2]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel2, "ar", "Text", "الكمية الكلية (كجم): [TotalQtn!N2]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel22, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(286.3512F, 23F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel22, "Default", "SizeF", new System.Drawing.SizeF(263.0238F, 23F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel22, "Default", "Text", "Total Quantity D.M (KG): [TotalQtn_DM!N2]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel22, "ar", "Text", "الكمية الكلية م.ج (كجم): [TotalQtn_DM!N2]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel3, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(9.998091F, 46.00002F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel3, "Default", "SizeF", new System.Drawing.SizeF(432.0852F, 23F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel4, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(0.001915296F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel4, "Default", "SizeF", new System.Drawing.SizeF(806.9964F, 23F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel4, "Default", "Text", "xrLabel4"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel5, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(628.0867F, 23F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel5, "Default", "SizeF", new System.Drawing.SizeF(89.78674F, 23F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel5, "Default", "Text", "Unit Cost:"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel5, "ar", "Text", "تكلفة الوحدة:"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel5, "Default", "TextFormatString", ""),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrPageInfo1, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(316.0001F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrPageInfo1, "Default", "SizeF", new System.Drawing.SizeF(192.7082F, 19.99999F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrPageInfo1, "Default", "TextFormatString", "{0:HH:mm:ss}"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrPageInfo2, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(628.0866F, 0.9167989F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrPageInfo2, "Default", "SizeF", new System.Drawing.SizeF(178.9134F, 19.0832F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrPageInfo2, "Default", "TextFormatString", "Page {0} of {1}"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTable1, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(0.001915296F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTable1, "Default", "SizeF", new System.Drawing.SizeF(796.9981F, 25F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTable3, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(1.589457E-05F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTable3, "Default", "SizeF", new System.Drawing.SizeF(796.9983F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTable5, "Default", "SizeF", new System.Drawing.SizeF(797F, 92.70832F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell1, "Default", "Text", "Nutrient"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell1, "ar", "Text", "العنصر"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell1, "Default", "Weight", 1.7860488865733875D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell10, "Default", "Weight", 0.61832707029919931D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell11, "Default", "Text", "Nutrient"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell11, "ar", "Text", "العنصر"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell11, "Default", "Weight", 1.3238119826957813D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell12, "Default", "Weight", 1.3679389309536825D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell13, "Default", "Weight", 3D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell14, "Default", "Weight", 0.67939814625880213D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell15, "Default", "Weight", 0.70204455957379075D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell16, "Default", "Text", "Unit"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell16, "ar", "Text", "الوحدة"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell16, "Default", "Weight", 0.57821774266819981D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell17, "Default", "Weight", 0.59749165920382186D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell18, "Default", "Text", "Diff"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell18, "ar", "Text", "الفرق"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell18, "Default", "Weight", 0.51773396278498918D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell19, "Default", "Weight", 0.53499228222683937D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell2, "Default", "Text", "Test"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell2, "Default", "Weight", 0.67363783684122813D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell20, "Default", "Text", "%"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell20, "Default", "Weight", 0.62099543032906268D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell21, "Default", "Weight", 0.64169635802197578D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell3, "Default", "Text", "Diff"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell3, "ar", "Text", "الفرق"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell3, "Default", "Weight", 0.46733147827576405D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell4, "Default", "Weight", 0.59837979580290035D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell5, "Default", "Weight", 0.4829077865536936D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell6, "Default", "Text", "%"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell6, "Default", "Weight", 0.46733147827576405D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell7, "Default", "Weight", 1.8455827967578204D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell8, "Default", "Weight", 0.69609175538611745D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell9, "Default", "Weight", 0.4829077865536936D),
            ...
            this.Version = "24.2";
            this.BeforePrint += new DevExpress.XtraReports.UI.BeforePrintEventHandler(this.RationResult_Nut_Diff_BeforePrint);
        ...
        private DevExpress.XtraReports.UI.CalculatedField UnitCost;
        private DevExpress.XtraReports.UI.XRLabel xrLabel5;
        private DevExpress.XtraReports.UI.XRControlStyle xrControlStyle1;
        private DevExpress.XtraReports.UI.CalculatedField Per;
        private DevExpress.XtraReports.UI.CalculatedField QuantityValue;
