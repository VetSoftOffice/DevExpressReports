namespace DevExpressReports.Reports.Monitoring.SR_MO_WorkTime
{
    partial class SR_MO_WorkTime
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SR_MO_WorkTime));
            ...
            this.dtProdCode = new DevExpress.XtraReports.UI.XRTableCell();
            ...
            this.TotalWorkHours = new DevExpress.XtraReports.UI.CalculatedField();
            this.TotalWorkMinutes = new DevExpress.XtraReports.UI.CalculatedField();
            this.TotalWorkHoursForSupport = new DevExpress.XtraReports.UI.CalculatedField();
            this.TotalWorkMinutesForSupport = new DevExpress.XtraReports.UI.CalculatedField();
            this.SupportPerc = new DevExpress.XtraReports.UI.CalculatedField();
            this.numerator = new DevExpress.XtraReports.UI.CalculatedField();
            this.denominator = new DevExpress.XtraReports.UI.CalculatedField();
            ...
            // dtProdCode
            // 
            this.dtProdCode.Borders = ((DevExpress.XtraPrinting.BorderSide)((((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Top) 
            | DevExpress.XtraPrinting.BorderSide.Right) 
            | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.dtProdCode.BorderWidth = 1.4F;
            this.dtProdCode.ExpressionBindings.AddRange(new DevExpress.XtraReports.UI.ExpressionBinding[] {
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[Grade]")});
            this.dtProdCode.Multiline = true;
            this.dtProdCode.Name = "dtProdCode";
            this.dtProdCode.StylePriority.UseBorders = false;
            this.dtProdCode.StylePriority.UseBorderWidth = false;
            this.dtProdCode.StylePriority.UseFont = false;
            this.dtProdCode.StylePriority.UseTextAlignment = false;
            this.dtProdCode.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            // 
            // xrTableCell12
            // 
            ...
            this.dtProduct.StylePriority.UseTextAlignment = false;
            this.dtProduct.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            // 
            // dtQuantity
            // 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[UserHour]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[UserMinute]"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')\n")});
            ...
            this.dtUnit.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleRight;
            // 
            // PageFooter
            // 
            ...
            // TotalWorkHours
            // 
            this.TotalWorkHours.DataMember = "SR_MO_WorkTime";
            this.TotalWorkHours.Expression = "((Sum([UserHour])) + (Sum([UserMinute])) / 60)";
            this.TotalWorkHours.Name = "TotalWorkHours";
            // 
            // TotalWorkMinutes
            // 
            this.TotalWorkMinutes.DataMember = "SR_MO_WorkTime";
            this.TotalWorkMinutes.Expression = "(Sum([UserMinute])) % 60";
            this.TotalWorkMinutes.Name = "TotalWorkMinutes";
            // 
            // TotalWorkHoursForSupport
            // 
            this.TotalWorkHoursForSupport.DataMember = "SR_MO_WorkTime";
            this.TotalWorkHoursForSupport.Expression = "sum([UserSupportHour]) + (sum([UserSupportMinute]) / 60)\n";
            this.TotalWorkHoursForSupport.Name = "TotalWorkHoursForSupport";
            // 
            // TotalWorkMinutesForSupport
            // 
            this.TotalWorkMinutesForSupport.DataMember = "SR_MO_WorkTime";
            this.TotalWorkMinutesForSupport.Expression = "sum([UserSupportMinute]) % 60\n";
            this.TotalWorkMinutesForSupport.Name = "TotalWorkMinutesForSupport";
            // 
            // SupportPerc
            // 
            this.SupportPerc.DataMember = "SR_MO_WorkTime";
            this.SupportPerc.Expression = "ToFloat([numerator]) / ToFloat([denominator]) \n";
            this.SupportPerc.Name = "SupportPerc";
            // 
            // numerator
            // 
            this.numerator.DataMember = "SR_MO_WorkTime";
            this.numerator.Expression = "(Sum([TotalWorkHoursForSupport]) * 60) + Sum([TotalWorkMinutesForSupport]) \n";
            this.numerator.Name = "numerator";
            // 
            // denominator
            // 
            this.denominator.DataMember = "SR_MO_WorkTime";
            this.denominator.Expression = "(Sum([TotalWorkHours]) * 60) + Sum([TotalWorkMinutes]) + \n            (Sum([Total" +
    "WorkHoursForSupport]) * 60) + Sum([TotalWorkMinutesForSupport])\n";
            ...
            this.TotalWorkHoursForSupport,
            this.TotalWorkMinutesForSupport,
            this.SupportPerc,
            this.numerator,
            this.denominator});
            ...
            this.dsInvtories,
            this.dsFinance1});
            this.DataMember = "SR_MO_WorkTime";
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.dtProdCode, "Default", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7.25F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.dtProdCode, "Default", "Text", ""),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.dtProdCode, "Default", "TextFormatString", "{0:#}"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.dtProdCode, "Default", "Weight", 5.9981170559170627D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.dtProduct, "Default", "Weight", 7.8541741847665882D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.dtQuantity, "Default", "Weight", 5.2129021420772048D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.dtSerialNo, "Default", "Weight", 4.8056928213939054D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.dtUnit, "Default", "Weight", 5.5706293238810982D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.GroupFooter1, "Default", "HeightF", 57.29162F),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.pageInfoCurrentDate, "Default", "SizeF", new System.Drawing.SizeF(314.9583F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.pageInfoCurrentTime, "Default", "SizeF", new System.Drawing.SizeF(317F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.pageInfoPageNoOfTotal, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(694.4582F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.pageInfoPageNoOfTotal, "Default", "SizeF", new System.Drawing.SizeF(329.5387F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.srReportFooterCustom, "Default", "SizeF", new System.Drawing.SizeF(1023.997F, 20F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.srReportHeader, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(9.999998F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.srReportHeader, "Default", "SizeF", new System.Drawing.SizeF(1014F, 20F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.srReportHeaderCustom, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(0.9997606F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.srReportHeaderCustom, "Default", "SizeF", new System.Drawing.SizeF(1022.997F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.srReportNotes, "Default", "SizeF", new System.Drawing.SizeF(1023.997F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.srReportSignature, "Default", "SizeF", new System.Drawing.SizeF(1023.997F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.srReportSignature_PageFooter, "Default", "SizeF", new System.Drawing.SizeF(1023.997F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.SubBand1, "Default", "HeightF", 0.5000432F),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel1, "Default", "SizeF", new System.Drawing.SizeF(274.8057F, 23F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel1, "Default", "Text", "Total Work:"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel1, "ar", "Text", "مجموع شغل:"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel2, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(181.6666F, 0F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel3, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(320.5971F, 34.29162F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel3, "ar", "LocationFloat", new DevExpress.Utils.PointFloat(320.5971F, 34.29162F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel3, "Default", "SizeF", new System.Drawing.SizeF(167.7084F, 23F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel3, "Default", "Text", "Hours: [TotalWorkHoursForSupport]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel3, "ar", "Text", "ساعة: [TotalWorkHoursForSupport]"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel4, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(0.9997606F, 0F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel5, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(320.5971F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel5, "Default", "SizeF", new System.Drawing.SizeF(167.7084F, 23F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel5, "Default", "Text", "Hours: [TotalWorkHours]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel5, "ar", "Text", "ساعة: [TotalWorkHours]"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel6, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(512.8749F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel6, "Default", "SizeF", new System.Drawing.SizeF(203.125F, 23F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel6, "Default", "Text", "Minutes: [TotalWorkMinutes]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel6, "ar", "Text", "دقيقة: [TotalWorkMinutes]"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel7, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(512.875F, 34.29162F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel7, "ar", "LocationFloat", new DevExpress.Utils.PointFloat(517.0417F, 34.29162F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel7, "Default", "SizeF", new System.Drawing.SizeF(203.125F, 23F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel7, "Default", "Text", "Minutes: [TotalWorkMinutesForSupport]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel7, "ar", "Text", "دقيقة: [TotalWorkMinutesForSupport]"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel8, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(0F, 34.29162F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel8, "Default", "SizeF", new System.Drawing.SizeF(275.8055F, 23F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel8, "Default", "Text", "Total Support([SupportPerc!#.00%]):"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel8, "ar", "Text", " ([SupportPerc#: 0.00%])مجموع الدعم الفني:"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTable1, "Default", "SizeF", new System.Drawing.SizeF(1024F, 25F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTable4, "Default", "SizeF", new System.Drawing.SizeF(1022.997F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell1, "Default", "Weight", 1.5730025213812477D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell10, "Default", "Text", "Start Date Time"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell10, "ar", "Text", "تاريخ وقت البداية"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell10, "Default", "Weight", 3.2392529296875D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell11, "Default", "Text", "User Name"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell11, "ar", "Text", "اسم المستخدم"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell11, "Default", "Weight", 3.2392529296875D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell12, "Default", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7.25F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell12, "Default", "Text", "xrTableCell12"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell12, "Default", "Weight", 16.478538547816367D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell13, "Default", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7.25F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell13, "Default", "Text", "xrTableCell13"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell13, "Default", "Weight", 10.029045598013157D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell14, "Default", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7.25F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell14, "Default", "Text", "xrTableCell14"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell14, "Default", "Weight", 10.029050518586862D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell2, "Default", "Text", "Grade"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell2, "ar", "Text", "الدرجة"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell2, "Default", "Weight", 1.9373136835698768D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell3, "Default", "Text", "End Date Time"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell3, "ar", "Text", "تاريخ وقت النهاية"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell3, "Default", "Weight", 2.5367910449332545D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell4, "Default", "Text", "User Hours"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell4, "ar", "Text", "الساعات"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell4, "Default", "Weight", 1.6837008459383345D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell5, "Default", "Text", "User Minute"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell5, "ar", "Text", "الدقائق"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell5, "Default", "Weight", 1.7993079467621924D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell9, "Default", "Text", "Employee Name"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell9, "ar", "Text", "اسم الموظف"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell9, "Default", "Weight", 5.3223559141895009D),
    ...
    "0\\VetSoftDevExpress.dll";
        ...
        private DevExpress.XtraReports.UI.XRTableCell dtProdCode;
        ...
        private DevExpress.XtraReports.UI.CalculatedField TotalWorkHours;
        private DevExpress.XtraReports.UI.CalculatedField TotalWorkMinutes;
        private DevExpress.XtraReports.UI.CalculatedField TotalWorkHoursForSupport;
        private DevExpress.XtraReports.UI.XRLabel xrLabel3;
        private DevExpress.XtraReports.UI.CalculatedField TotalWorkMinutesForSupport;
        private DevExpress.XtraReports.UI.XRLabel xrLabel8;
        private DevExpress.XtraReports.UI.XRLabel xrLabel7;
        private DevExpress.XtraReports.UI.CalculatedField SupportPerc;
        private DevExpress.XtraReports.UI.CalculatedField numerator;
        private DevExpress.XtraReports.UI.CalculatedField denominator;
    }
}
