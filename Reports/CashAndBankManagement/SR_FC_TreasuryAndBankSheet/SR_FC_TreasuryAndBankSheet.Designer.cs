...
{
    partial class SR_FC_TreasuryAndBankSheet
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SR_FC_TreasuryAndBankSheet));
            ...
            this.sR_FC_TreasuryAndBankSheetTableAdapter = new DevExpressReports.Reports.GeneralLedger.DataSets.dsGeneralLedgerTableAdapters.SR_FC_TreasuryAndBankSheetTableAdapter();
            ...
            this.Treasury = new DevExpress.XtraReports.Parameters.Parameter();
            ...
            // 
            // sR_FC_TreasuryAndBankSheetTableAdapter
            // 
            this.sR_FC_TreasuryAndBankSheetTableAdapter.ClearBeforeFill = true;
            // 
            // TopMargin
            // 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "iif\n(\n\tIsNull([OpenBalance], 0) + sumRunningSum([DebitMinusCredit]) < 0,\n\tAbs(IsN" +
                    "ull([OpenBalance], 0) + sumRunningSum([DebitMinusCredit])),\n\tnull\n)\n")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Visible", "!IsNullOrEmpty(?Treasury)")});
            ...
            new DevExpress.XtraReports.UI.GroupField("ItemCode_Treasury", DevExpress.XtraReports.UI.XRColumnSortOrder.Ascending)});
            ...
            // lblCredit
            // 
            this.lblCredit.Borders = DevExpress.XtraPrinting.BorderSide.None;
            this.lblCredit.ExpressionBindings.AddRange(new DevExpress.XtraReports.UI.ExpressionBinding[] {
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Visible", "IsNull([OpenBalance], 0) < 0")});
            this.lblCredit.Name = "lblCredit";
            this.lblCredit.StylePriority.UseFont = false;
            this.lblCredit.StylePriority.UseTextAlignment = false;
            this.lblCredit.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            // 
            // lblDebit
            // 
            this.lblDebit.Borders = DevExpress.XtraPrinting.BorderSide.None;
            this.lblDebit.ExpressionBindings.AddRange(new DevExpress.XtraReports.UI.ExpressionBinding[] {
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Visible", "IsNull([OpenBalance], 0) > 0")});
            this.lblDebit.Name = "lblDebit";
            this.lblDebit.StylePriority.UseFont = false;
            this.lblDebit.StylePriority.UseTextAlignment = false;
            this.lblDebit.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            // 
            // xrLabel8
            // 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[ItemCode_Treasury]")});
            ...
            this.tfDebit_GPT.Summary = xrSummary3;
            ...
            this.tfCredit_GPT.Summary = xrSummary4;
            ...
            // DebitMinusCredit
            // 
            this.DebitMinusCredit.DataMember = "SR_FC_TreasuryAndBankSheet";
            ...
            this.DataMember = "SR_FC_TreasuryAndBankSheet";
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.lblCredit, "ar", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7F, DevExpress.Drawing.DXFontStyle.Bold)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.lblCredit, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(752.5001F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.lblCredit, "Default", "SizeF", new System.Drawing.SizeF(52.49994F, 20F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.lblCredit, "Default", "Text", "Credit"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.lblCredit, "ar", "Text", "دائن"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.lblDebit, "ar", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7F, DevExpress.Drawing.DXFontStyle.Bold)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.lblDebit, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(752.5001F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.lblDebit, "Default", "SizeF", new System.Drawing.SizeF(52.49994F, 20F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.lblDebit, "Default", "Text", "Debit"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.lblDebit, "ar", "Text", "مدين"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.pageInfoCurrentTime, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(342.2083F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.pageInfoCurrentTime, "Default", "SizeF", new System.Drawing.SizeF(184.2917F, 20F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.pageInfoCurrentTime, "Default", "TextFormatString", "{0:HH:mm:ss}"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.pageInfoPageNoOfTotal, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(598F, 0F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this, "Default", "DisplayName", "كشف حساب الخزينة والبنك"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.SubBand1, "Default", "HeightF", 20.00003F),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tDetail, "Default", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7.25F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tfCredit_GPT, "Default", "Font", new DevExpress.Drawing.DXFont("Tahoma", 6F, DevExpress.Drawing.DXFontStyle.Bold)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tfCredit_GPT, "Default", "Weight", 0.38765593164825529D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tfCredit_GPT, "ar", "Weight", 0.38696781163289939D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tfDebit_GPT, "Default", "Font", new DevExpress.Drawing.DXFont("Tahoma", 6F, DevExpress.Drawing.DXFontStyle.Bold)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tfDebit_GPT, "Default", "Weight", 0.38765573276935961D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tfDebit_GPT, "ar", "Weight", 0.38696761275400365D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tFooter, "Default", "Font", new DevExpress.Drawing.DXFont("Times New Roman", 9.75F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tfTotal, "Default", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7F, DevExpress.Drawing.DXFontStyle.Bold)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tfTotal, "Default", "Weight", 1.878639278268273D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tfTotal, "ar", "Weight", 1.8753056888024624D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.Treasury, "Default", "Description", "Treasury / Bank"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.Treasury, "ar", "Description", "الخزينة / البنك"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel1, "ar", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7.25F, DevExpress.Drawing.DXFontStyle.Bold)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel10, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(143.3578F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel10, "Default", "SizeF", new System.Drawing.SizeF(199.1932F, 20F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel10, "Default", "Text", "[?AccountDim]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel15, "ar", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7F, DevExpress.Drawing.DXFontStyle.Bold)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel15, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(4.673004E-05F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel15, "Default", "SizeF", new System.Drawing.SizeF(287.716F, 20F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel15, "Default", "Text", "Type: [ItemCode_Treasury]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel2, "ar", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7F, DevExpress.Drawing.DXFontStyle.Bold)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel3, "ar", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7F, DevExpress.Drawing.DXFontStyle.Bold)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel3, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(285.6205F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel3, "Default", "SizeF", new System.Drawing.SizeF(121.4413F, 20F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel3, "Default", "Text", "Type: [ItemType_Treasury]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel3, "ar", "Text", "النوع: [ItemType_Treasury]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel4, "ar", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7F, DevExpress.Drawing.DXFontStyle.Bold)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel4, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(407.0619F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel4, "Default", "SizeF", new System.Drawing.SizeF(126.3296F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel5, "ar", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7F, DevExpress.Drawing.DXFontStyle.Bold)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel5, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(288.716F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel5, "Default", "SizeF", new System.Drawing.SizeF(212.2795F, 20F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel5, "Default", "Text", "Treasury / Bank: [?Treasury]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel5, "ar", "Text", "الخزينة / البنك: [?Treasury]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel6, "ar", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7F, DevExpress.Drawing.DXFontStyle.Bold)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel6, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(500.9955F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel6, "Default", "SizeF", new System.Drawing.SizeF(268.1295F, 20F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel6, "Default", "Text", "Action Type: [?ActionType]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel6, "ar", "Text", "نوع الحركة: [?ActionType]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel7, "ar", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7F, DevExpress.Drawing.DXFontStyle.Bold)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel7, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(533.3915F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel7, "Default", "SizeF", new System.Drawing.SizeF(106.6085F, 20F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel7, "Default", "Text", "Open Balance:"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel7, "ar", "Text", "الرصيد الافتتاحي:"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel8, "ar", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7F, DevExpress.Drawing.DXFontStyle.Bold)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel8, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(640.0001F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel8, "Default", "SizeF", new System.Drawing.SizeF(112.5F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel9, "Default", "SizeF", new System.Drawing.SizeF(143.3578F, 20.00003F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrPanel1, "Default", "SizeF", new System.Drawing.SizeF(805F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell1, "Default", "Text", "[RegDate!dd-MM-yyyy]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell1, "Default", "Weight", 12.233668983603421D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell10, "Default", "Font", new DevExpress.Drawing.DXFont("Tahoma", 6F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell10, "Default", "Weight", 14.457972167958774D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell11, "Default", "Font", new DevExpress.Drawing.DXFont("Tahoma", 6F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell11, "Default", "Weight", 14.457972083687038D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell12, "Default", "Text", "[Notes]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell12, "Default", "Weight", 51.158981754031757D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell13, "Default", "Text", ""),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell13, "Default", "Weight", 15.392850223153934D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell14, "ar", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7F, DevExpress.Drawing.DXFontStyle.Bold)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell14, "Default", "Text", "Doc. Type"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell14, "ar", "Text", "نوع المستند"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell14, "Default", "Weight", 14.664216737231175D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell15, "ar", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7F, DevExpress.Drawing.DXFontStyle.Bold)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell15, "Default", "Text", "Doc. No"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell15, "ar", "Text", "رقم المستند"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell15, "Default", "Weight", 8.248622423490664D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell17, "ar", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7F, DevExpress.Drawing.DXFontStyle.Bold)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell17, "Default", "Text", "Movement"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell17, "ar", "Text", "الحركات"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell17, "Default", "Weight", 23.829352383986503D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell18, "Default", "Weight", 0.38765592515830455D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell18, "ar", "Weight", 0.38696762346109637D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell19, "ar", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7F, DevExpress.Drawing.DXFontStyle.Bold)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell19, "Default", "Weight", 23.829353858100983D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell2, "ar", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7F, DevExpress.Drawing.DXFontStyle.Bold)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell2, "Default", "Weight", 10.081648950361426D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell20, "Default", "Text", ""),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell20, "Default", "Weight", 1.3717051690944708D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell20, "ar", "Weight", 1.369271149783686D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell21, "ar", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7F, DevExpress.Drawing.DXFontStyle.Bold)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell21, "Default", "Text", "Notes"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell21, "ar", "Text", "ملاحظات"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell21, "Default", "Weight", 42.159622998307846D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell22, "Default", "Weight", 9.406742430180012D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell23, "Default", "Weight", 7.6964252961520154D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell25, "Default", "Weight", 13.68253406389683D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell27, "ar", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7F, DevExpress.Drawing.DXFontStyle.Bold)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell27, "Default", "Weight", 11.117058922500535D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell28, "ar", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7F, DevExpress.Drawing.DXFontStyle.Bold)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell28, "Default", "Weight", 11.117058922500547D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell29, "ar", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7F, DevExpress.Drawing.DXFontStyle.Bold)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell29, "Default", "Weight", 11.117059388903506D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell3, "Default", "Weight", 17.794427372529206D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell30, "ar", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7F, DevExpress.Drawing.DXFontStyle.Bold)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell30, "Default", "Weight", 11.117058488939383D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell31, "Default", "Text", "Notes"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell31, "Default", "Weight", 39.337285609189031D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell32, "Default", "Weight", 10.009365890956115D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell33, "ar", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7F, DevExpress.Drawing.DXFontStyle.Bold)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell33, "Default", "Text", "Doc. Status"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell33, "ar", "Text", "حالة المستند"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell33, "Default", "Weight", 8.2486219374743825D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell34, "Default", "Text", ""),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell34, "Default", "Weight", 7.6964252531242172D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell4, "Default", "Weight", 20.018731351897213D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell5, "Default", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell5, "Default", "Text", "[DocNumber]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell5, "Default", "Weight", 10.009365805606729D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell6, "ar", "Font", new DevExpress.Drawing.DXFont("Tahoma", 7F, DevExpress.Drawing.DXFontStyle.Bold)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell6, "Default", "Text", "Source"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell6, "ar", "Text", "المصدر"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell6, "Default", "Weight", 16.497244557840325D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell7, "Default", "Font", new DevExpress.Drawing.DXFont("Tahoma", 6F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell7, "Default", "Text", "[Debit!N2]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell7, "Default", "TextFormatString", "{0:#,##0.00;#,##0.00;\'\'}"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell7, "Default", "Weight", 14.457972167958777D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell8, "Default", "Weight", 0.38765519054536884D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell8, "ar", "Weight", 0.38696761557556969D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell9, "Default", "Font", new DevExpress.Drawing.DXFont("Tahoma", 6F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell9, "Default", "Text", "[Credit!N2]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell9, "Default", "TextFormatString", "{0:#,##0.00;#,##0.00;\'\'}"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell9, "Default", "Weight", 14.45797216795876D)});
            ...
            new DevExpress.XtraReports.Parameters.ParameterLayoutItem(this.Treasury, DevExpress.XtraReports.Parameters.Orientation.Vertical),
    ...
    "0\\VetSoftDevExpress.dll";
        ...
        private Reports.GeneralLedger.DataSets.dsGeneralLedgerTableAdapters.SR_FC_TreasuryAndBankSheetTableAdapter sR_FC_TreasuryAndBankSheetTableAdapter;
        ...
        private DevExpress.XtraReports.Parameters.Parameter Treasury;
