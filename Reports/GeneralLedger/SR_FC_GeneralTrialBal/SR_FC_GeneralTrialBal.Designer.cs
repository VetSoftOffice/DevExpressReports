...
{
    partial class SR_FC_GeneralTrialBal
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SR_FC_GeneralTrialBal));
            ...
            this.Date_To = new DevExpress.XtraReports.UI.XRLabel();
            this.Date_From = new DevExpress.XtraReports.UI.XRLabel();
            ...
            this.CloseBalance = new DevExpress.XtraReports.UI.CalculatedField();
            ...
            this.dsGeneralLedger1 = new DevExpress.DataAccess.Sql.SqlDataSource(this.components);
            ...
            this.CloseCredit = new DevExpress.XtraReports.UI.CalculatedField();
            this.AccountCcHeader = new DevExpress.XtraReports.Parameters.Parameter();
            this.groupHeader_CC = new DevExpress.XtraReports.UI.GroupHeaderBand();
            ...
            this.groupFooter_CC = new DevExpress.XtraReports.UI.GroupFooterBand();
            ...
            this.NumberFormatString = new DevExpress.XtraReports.Parameters.Parameter();
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "FormatString(?NumberFormatString, [OpenDebit])")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')\n"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "FormatString(?NumberFormatString, [OpenCredit])")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')\n"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "FormatString(?NumberFormatString, [Debit])")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')\n\n"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "FormatString(?NumberFormatString, [Credit])")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')\n\n\n"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "Iif(IsNull([CloseBalance]) Or [CloseBalance] <= 0.005 Or [CloseBalance] <= 0, \'\'," +
                    " FormatString(?NumberFormatString, [CloseBalance]))")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')\n\n"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "Iif(IsNull([CloseBalance]) Or [CloseBalance] >= -0.0049 Or [CloseBalance] >= 0, \'" +
                    "\', FormatString(?NumberFormatString, Abs([CloseBalance])))")});
            ...
            this.PageHeaderSub1.Scripts.OnBeforePrint = "PageHeaderSub1_BeforePrint";
            // 
            // xrLabel5
            // 
            ...
            // Date_To
            // 
            this.Date_To.CanGrow = false;
            this.Date_To.CanPublishOptions.Xls = false;
            this.Date_To.CanPublishOptions.Xlsx = false;
            this.Date_To.Name = "Date_To";
            this.Date_To.ProcessNullValues = DevExpress.XtraReports.UI.ValueSuppressType.SuppressAndShrink;
            // 
            // Date_From
            // 
            this.Date_From.CanGrow = false;
            this.Date_From.CanPublishOptions.Xls = false;
            this.Date_From.CanPublishOptions.Xlsx = false;
            this.Date_From.Name = "Date_From";
            this.Date_From.ProcessNullValues = DevExpress.XtraReports.UI.ValueSuppressType.SuppressAndShrink;
            // 
            // SubBand1
            // 
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Visible", "Iif(?WhichReport=7,false ,true )\n\n")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "?AccountCcHeader")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')\r\n"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "FormatString(?NumberFormatString, sumSum([OpenDebit]))")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')\r\n"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "FormatString(?NumberFormatString, sumSum([OpenCredit]))")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')\n\n"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "FormatString(?NumberFormatString, sumSum([Debit]))")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')\n\n"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "FormatString(?NumberFormatString, sumSum([Credit]))")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')\n\n"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "FormatString(?NumberFormatString, sumSum(Iif([CloseBalance] > 0, [CloseBalance], " +
                    "0)))")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')\n\n"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "FormatString(?NumberFormatString, sumSum(Iif([CloseBalance] < 0, Abs([CloseBalanc" +
                    "e]), 0)))")});
            ...
            // CloseBalance
            // 
            this.CloseBalance.DataMember = "SR_FC_AccountBalance";
            this.CloseBalance.Expression = "IsNull([OpenDebit] ,0 ) + IsNull([Debit] ,0 ) - IsNull([OpenCredit], 0)- IsNull([" +
    "Credit],0 )";
            this.CloseBalance.FieldType = DevExpress.XtraReports.UI.FieldType.Decimal;
            ...
            // WhichReport
            // 
            this.WhichReport.Enabled = false;
            this.WhichReport.Name = "WhichReport";
            this.WhichReport.Visible = false;
            // 
            // dsGeneralLedger1
            // 
            this.dsGeneralLedger1.ConnectionName = "dsGeneralLedger";
            this.dsGeneralLedger1.Name = "dsGeneralLedger1";
            ...
            columnExpression111.ColumnName = "tStActionID";
            table6.Name = "SR_FC_TreasuryAndBankSheet";
            columnExpression111.Table = table6;
            column111.Expression = columnExpression111;
            columnExpression112.ColumnName = "DocNumber";
            columnExpression112.Table = table6;
            column112.Expression = columnExpression112;
            columnExpression113.ColumnName = "RegDate";
            ...
            columnExpression131.ColumnName = "DocStatus";
            ...
            selectQuery6.Name = "SR_FC_TreasuryAndBankSheet";
            selectQuery6.Tables.Add(table6);
            this.dsGeneralLedger1.Queries.AddRange(new DevExpress.DataAccess.Sql.SqlQuery[] {
            selectQuery1,
            selectQuery2,
            selectQuery3,
            selectQuery4,
            selectQuery5,
            selectQuery6});
            this.dsGeneralLedger1.ResultSchemaSerializable = resources.GetString("dsGeneralLedger1.ResultSchemaSerializable");
            // 
            // OpenDebit
            // 
            this.OpenDebit.DataMember = "SR_FC_AccountBalance";
            this.OpenDebit.Expression = "Iif([OpenBalance]>0, [OpenBalance], null)";
            this.OpenDebit.Name = "OpenDebit";
            // 
            // OpenCredit
            // 
            this.OpenCredit.DataMember = "SR_FC_AccountBalance";
            this.OpenCredit.Expression = "Iif([OpenBalance]<0, abs([OpenBalance]), null)\n";
            this.OpenCredit.Name = "OpenCredit";
            // 
            // CloseDebit
            // 
            this.CloseDebit.DataMember = "SR_FC_AccountBalance";
            this.CloseDebit.Expression = "Iif([CloseBalance]>0, [CloseBalance], null)\n";
            this.CloseDebit.Name = "CloseDebit";
            // 
            // CloseCredit
            // 
            this.CloseCredit.DataMember = "SR_FC_AccountBalance";
            this.CloseCredit.Expression = "Iif([CloseBalance]<0, Abs([CloseBalance]), null)\n";
            this.CloseCredit.Name = "CloseCredit";
            // 
            // AccountCcHeader
            // 
            this.AccountCcHeader.Enabled = false;
            this.AccountCcHeader.Name = "AccountCcHeader";
            this.AccountCcHeader.Visible = false;
            // 
            // groupHeader_CC
            // 
            this.groupHeader_CC.Controls.AddRange(new DevExpress.XtraReports.UI.XRControl[] {
            this.xrLabel3,
            this.xrTable3});
            this.groupHeader_CC.ExpressionBindings.AddRange(new DevExpress.XtraReports.UI.ExpressionBinding[] {
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Visible", "Iif(?WhichReport=7,true ,false )")});
            this.groupHeader_CC.GroupFields.AddRange(new DevExpress.XtraReports.UI.GroupField[] {
            new DevExpress.XtraReports.UI.GroupField("CC", DevExpress.XtraReports.UI.XRColumnSortOrder.Ascending)});
            this.groupHeader_CC.Name = "groupHeader_CC";
            this.groupHeader_CC.RepeatEveryPage = true;
            // 
            // xrLabel3
            // 
            this.xrLabel3.ExpressionBindings.AddRange(new DevExpress.XtraReports.UI.ExpressionBinding[] {
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[CC]")});
            ...
            // groupFooter_CC
            // 
            this.groupFooter_CC.Controls.AddRange(new DevExpress.XtraReports.UI.XRControl[] {
            this.xrTable4});
            this.groupFooter_CC.ExpressionBindings.AddRange(new DevExpress.XtraReports.UI.ExpressionBinding[] {
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Visible", "Iif(?WhichReport=7,true ,false )\n")});
            this.groupFooter_CC.Name = "groupFooter_CC";
            // 
            // xrTable4
            // 
            ...
            // NumberFormatString
            // 
            this.NumberFormatString.Name = "NumberFormatString";
            this.NumberFormatString.ValueInfo = "{0:#,##0.####;(#,##0.####)}";
            this.NumberFormatString.Visible = false;
            // 
            // SR_FC_GeneralTrialBal
            // 
            ...
            this.DataMember = "SR_FC_AccountBalance";
            this.DataSource = this.dsGeneralLedger1;
            this.ExportOptions.Pdf.DocumentOptions.Author = "VetSoft";
            this.LocalizationItems.AddRange(new DevExpress.XtraReports.Localization.LocalizationItem[] {
            new DevExpress.XtraReports.Localization.LocalizationItem(this.AccountCcHeader, "Default", "Description", "Parameter1"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.BottomMargin, "Default", "Visible", true),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.Date_From, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(7.947286E-06F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.Date_From, "Default", "SizeF", new System.Drawing.SizeF(144.358F, 20F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.Date_From, "Default", "Text", "From: [?DateFrom!dd-MM-yyyy]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.Date_From, "ar", "Text", "من: [?DateFrom!dd-MM-yyyy]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.Date_From, "Default", "Visible", true),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.Date_To, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(144.358F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.Date_To, "Default", "SizeF", new System.Drawing.SizeF(144.358F, 20F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.Date_To, "Default", "Text", "To: [?DateTo!dd-MM-yyyy]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.Date_To, "ar", "Text", "إلى: [?DateTo!dd-MM-yyyy]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.Date_To, "Default", "Visible", true),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.groupFooter_CC, "Default", "HeightF", 20F),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.groupHeader_CC, "Default", "HeightF", 63F),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.NumberFormatString, "Default", "Description", " Custom Number Format String"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.pageInfoCurrentDate, "Default", "Visible", true),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.pageInfoCurrentTime, "Default", "Visible", true),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.pageInfoPageNoOfTotal, "Default", "Visible", true),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.srReportSignature_PageFooter, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(0.999999F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.srReportSignature_PageFooter, "Default", "SizeF", new System.Drawing.SizeF(805.9999F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.SubBand1, "Default", "HeightF", 40.00003F),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tdCredit, "Default", "TextFormatString", ""),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tdCredit, "Default", "Weight", 0.22522229819153008D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tdCreditBal, "Default", "TextFormatString", ""),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tdCreditBal, "Default", "Weight", 0.22410182329150971D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tdDebit, "Default", "Weight", 0.2252223323867539D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tdDebitBal, "Default", "TextFormatString", ""),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tdDebitBal, "Default", "Weight", 0.22410182329150974D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tDetail, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(1.525879E-05F, 0F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel3, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(158.0555F, 3F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel3, "Default", "SizeF", new System.Drawing.SizeF(297.94F, 20F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel3, "Default", "Text", ""),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel4, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(534.3994F, 0F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel4, "Default", "Visible", true),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel5, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(391.0416F, 0F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel5, "Default", "Visible", true),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTable1, "Default", "SizeF", new System.Drawing.SizeF(806F, 20F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTable2, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(205F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTable2, "Default", "SizeF", new System.Drawing.SizeF(601F, 40F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTable2, "Default", "Visible", true),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTable3, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(1F, 23F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTable3, "Default", "SizeF", new System.Drawing.SizeF(805F, 40F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTable4, "Default", "SizeF", new System.Drawing.SizeF(806F, 20F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTable5, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(4.768372E-05F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTable5, "Default", "SizeF", new System.Drawing.SizeF(205F, 40.00003F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell1, "Default", "Text", "CostCenter"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell1, "ar", "Text", "مركز التكلفة"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell1, "Default", "Weight", 1.9333963206404476D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell10, "Default", "Text", "Credit"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell10, "ar", "Text", "دائن"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell10, "Default", "Weight", 0.81645043248339255D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell11, "Default", "Text", "Debit"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell11, "ar", "Text", "مدين"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell11, "Default", "Weight", 0.81238836648408441D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell12, "Default", "Text", "Credit"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell12, "ar", "Text", "دائن"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell12, "Default", "Weight", 0.81238836648408441D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell13, "Default", "Text", "Debit"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell13, "ar", "Text", "مدين"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell13, "Default", "Weight", 0.81238836648408441D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell14, "Default", "Text", "Credit"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell14, "ar", "Text", "دائن"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell14, "Default", "Weight", 0.81238836648408441D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell16, "Default", "Text", "tfCreditBal_GPT"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell16, "Default", "TextFormatString", ""),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell16, "Default", "Weight", 0.80960039720650623D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell17, "Default", "Weight", 0.22410182329150971D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell18, "Default", "Weight", 0.22410182329150971D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell19, "Default", "Weight", 0.78631936754295484D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell2, "Default", "TextFormatString", ""),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell2, "Default", "Weight", 0.801623918100571D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell20, "Default", "Weight", 0.79874907755672941D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell21, "Default", "Weight", 0.79874907755672941D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell23, "Default", "Weight", 0.45940873778932168D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell24, "Default", "Text", "Grand Total"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell24, "ar", "Text", "اجمالي كلي"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell24, "Default", "Weight", 1.6351531459622579D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell25, "Default", "Text", "Close Balance"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell25, "ar", "Text", "رصيد ختامي"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell25, "Default", "Weight", 1.8862405211516429D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell26, "Default", "Text", "xrTableCell22"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell26, "Default", "Weight", 1.6653959599454236D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell27, "Default", "Text", "Debit"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell27, "ar", "Text", "مدين"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell27, "Default", "Weight", 0.81238836648408441D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell28, "Default", "Weight", 0.81238836648408441D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell29, "Default", "Text", "Debit"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell29, "ar", "Text", "مدين"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell29, "Default", "Weight", 0.81238836648408441D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell3, "Default", "Text", "Open Balance"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell3, "ar", "Text", "رصيد إفتتاحي"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell3, "Default", "Weight", 1.8862405211516429D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell30, "Default", "Text", "Credit"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell30, "ar", "Text", "دائن"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell30, "Default", "Weight", 0.81238836648408441D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell31, "Default", "Text", "Debit"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell31, "ar", "Text", "مدين"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell31, "Default", "Weight", 0.81238836648408441D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell32, "Default", "Text", "Credit"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell32, "ar", "Text", "دائن"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell32, "Default", "Weight", 0.81238836648408441D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell33, "Default", "Text", "Total"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell33, "ar", "Text", "اجمالي"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell33, "Default", "Weight", 1.6351533893813681D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell34, "Default", "Text", "tfDebit_GPT"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell34, "Default", "TextFormatString", ""),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell34, "Default", "Weight", 0.801623918100571D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell35, "Default", "Text", "tfCreditBal_GPT"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell35, "Default", "TextFormatString", ""),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell35, "Default", "Weight", 0.80960015378739625D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell36, "Default", "Text", "xrTableCell19"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell36, "Default", "TextFormatString", ""),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell36, "Default", "Weight", 0.78631936754295484D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell37, "Default", "Text", "xrTableCell20"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell37, "Default", "TextFormatString", ""),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell37, "Default", "Weight", 0.79874907755672941D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell38, "Default", "Text", "xrTableCell21"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell38, "Default", "TextFormatString", "{0:N2}"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell38, "Default", "Weight", 0.79874907755672941D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell39, "Default", "Text", "xrTableCell4"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell39, "Default", "TextFormatString", "{0:N2}"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell39, "Default", "Weight", 0.79874907755672941D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell4, "Default", "Weight", 0.79874907755672941D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell5, "Default", "Text", "Open Balance"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell5, "ar", "Text", "رصيد إفتتاحي"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell5, "Default", "Weight", 1.8956718676661322D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell6, "Default", "Text", "Movement Total"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell6, "ar", "Text", "إجمالي الحركة"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell6, "Default", "Weight", 1.8862405211516429D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell7, "Default", "Text", "Close Balance\r\n"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell7, "ar", "Text", "رصيد ختامي"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell7, "Default", "Weight", 1.8862405211516429D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell8, "Default", "Text", "Movement Total"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell8, "ar", "Text", "اجمالي الحركة"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell8, "Default", "Weight", 1.8862405211516429D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell9, "Default", "Text", "Debit"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell9, "ar", "Text", "مدين"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell9, "Default", "Weight", 0.81645030811024433D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableRow1, "Default", "Weight", 1D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableRow2, "Default", "Weight", 0.5D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableRow3, "Default", "Weight", 0.5D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableRow4, "Default", "Weight", 0.5D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableRow5, "Default", "Weight", 0.5D),
            ...
            new DevExpress.XtraReports.Parameters.ParameterLayoutItem(this.AccountCcHeader, DevExpress.XtraReports.Parameters.Orientation.Horizontal),
            ...
            this.DateTo,
            this.WhichReport,
            this.AccountCcHeader,
            this.AccountDim,
            this.NumberFormatString});
    ...
    "0\\VetSoftDevExpress.dll";
            this.Scripts.OnAfterPrint = "SR_FC_GeneralTrialBal_AfterPrint";
            this.Scripts.OnBeforePrint = "SR_FC_GeneralTrialBal_BeforePrint";
        ...
        private DevExpress.XtraReports.UI.XRLabel Date_To;
        private DevExpress.XtraReports.UI.XRLabel Date_From;
        private DevExpress.XtraReports.UI.CalculatedField CloseBalance;
        ...
        private DevExpress.DataAccess.Sql.SqlDataSource dsGeneralLedger1;
        ...
        private DevExpress.XtraReports.UI.CalculatedField CloseCredit;
        private DevExpress.XtraReports.Parameters.Parameter AccountCcHeader;
        private DevExpress.XtraReports.UI.GroupHeaderBand groupHeader_CC;
        ...
        private DevExpress.XtraReports.UI.GroupFooterBand groupFooter_CC;
        ...
        private DevExpress.XtraReports.Parameters.Parameter NumberFormatString;
    }
}