namespace DevExpressReports.Reports.Hatchery.Summary.SR_HT_FlkSumProdReport
{
    ...
    "\n";
            ...
            this.Data.Expression = "Iif(?IsRTL, \'??????\' , \'Date\' )";
            this.Data.Name = "Data";
            // 
            // Week
            // 
            this.Week.DataMember = "SR_HT_FlkSumProdReport";
            this.Week.Expression = "Iif(?IsRTL, \'?????\' , \'Week\' )";
            this.Week.Name = "Week";
            // 
            // Day
            // 
            this.Day.DataMember = "SR_HT_FlkSumProdReport";
            this.Day.Expression = "Iif(?IsRTL,\'???\', \'Day\')";
            this.Day.Name = "Day";
            // 
            // Performance
            // 
            this.Performance.DataMember = "SR_HT_FlkSumProdReport";
            this.Performance.Expression = "Iif(?IsRTL,\'????\' , \'Performance\')";
    ...
    "\' + ToStr([DaysNO]) + [Days])";
            ...
            this.Days.Expression = "iif(?IsRTL,\'????\',\'days\')";
            this.Days.Name = "Days";
            // 
            // RejDef
            // 
    ...
    " 0, [AB_RejChicksHH])\n";
            ...
            this.After.Expression = "iif(?IsRTL,\'???\',\'After\')";
    ...
    "lesDepleted] / [SR_HT_FlkSumProdReport.FemalesTrans] * 100, \n    0)\n";
            ...
            this.Week_CF.Expression = "Iif(?IsRTL, \'??????\' , \'Weeks\')";
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel6, "ar", "Text", "???? ??????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell102, "ar", "Text", "\\1- ?????? ???????? ??????? (????? ??????)"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell105, "ar", "Text", "???? ????? ????????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell122, "ar", "Text", "2- ???????? ???????? ??? ????? ??????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell125, "ar", "Text", "?????? ???????? (????? ??????)"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell14, "ar", "Text", "????? ??? ????? (POL)"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell143, "ar", "Text", "?????? ??????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell144, "ar", "Text", "????? ??????? ?? ?????? ????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell146, "ar", "Text", "????? ???????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell153, "ar", "Text", "????? ????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell155, "ar", "Text", "?????? ????? ???????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell157, "ar", "Text", "???? ??? ??????? ???????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell159, "ar", "Text", "????? ??????? ?? ??????? ???????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell161, "ar", "Text", "?????? ???????? (??? ????? ???????)"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell163, "ar", "Text", "???? ????? ????????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell165, "ar", "Text", "???????? ????????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell167, "ar", "Text", "?????? ?????? ?????? ??????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell169, "ar", "Text", "????? ??????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell170, "ar", "Text", "??? ???????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell172, "ar", "Text", "??? ???????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell174, "ar", "Text", "????? ?????? ????????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell176, "ar", "Text", "?????? ????? ??????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell178, "ar", "Text", "???????? ???????? (??? ????? ??????)"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell186, "ar", "Text", "?????? ???????? (?????? + ???????)"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell188, "ar", "Text", "?????? ????? ??????? (????? ??????)"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell19, "ar", "Text", "????? ?????????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell203, "ar", "Text", "?????? ????? ??????? (????? ??????)"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell206, "ar", "Text", "?????? ??? ??????? ??????? (????? ??????)"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell212, "ar", "Text", "1- ?????? ???????? ??????? (????? ??????)"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell218, "ar", "Text", "?????? ???????? ???????? (????? ??????)"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell22, "ar", "Text", "??? ?????? ????????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell221, "Default", "Text", "Cum A grade Chicks(Actual)  HH                                                   " +
                    "       "),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell221, "ar", "Text", "?????? ?????? ?????? ?????? (?????? - ????? ??????)"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell236, "ar", "Text", "2- ???????? ???????? ??? ????? ??????\tHH"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell245, "ar", "Text", "?????? ???????? (????? ??????)"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell251, "ar", "Text", "?????? ????? (????? ??????)"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell253, "ar", "Text", "?????? ???????? (????? ??????)"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell254, "ar", "Text", "????? ??????? (????? ??????)"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell256, "ar", "Text", "???????? ???????? (????? ??????)"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell257, "ar", "Text", "?????? ??? ??????? (????? ??????)"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell259, "ar", "Text", "?????? ?????? ?????? ?????? (????? ??????)"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell260, "ar", "Text", "???? ????? ????????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell28, "ar", "Text", "??? ?????? ??? ?????????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell3, "ar", "Text", "??? ???????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell43, "ar", "Text", "?????? ????? ???????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell44, "ar", "Text", "????? ????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell46, "ar", "Text", "???? ??? ??????? ???????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell50, "ar", "Text", "????? ??????? ?? ??????? ???????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell53, "ar", "Text", "?????? ???????? (??? ????? ???????)"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell60, "ar", "Text", "????? ?????? ????????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell67, "ar", "Text", "?????? ????? ???????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell69, "ar", "Text", "???????? ???????? (??? ????? ??????)"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell72, "ar", "Text", "???? ??? ??????? ?? ???????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell75, "ar", "Text", "???????? ???????? (??? ???? ??? ???????)"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell78, "ar", "Text", "???? ????? ?????? ????? ???????"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell81, "ar", "Text", "?????? ???????? (?????? + ???????)"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell88, "ar", "Text", "?????? ?????? ?????? ?????? (?????? - ????? ??????)"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell93, "ar", "Text", "?????? ????? ??????? (????? ??????)"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell96, "ar", "Text", "?????? ??? ??????? ??????? (????? ??????)"),
