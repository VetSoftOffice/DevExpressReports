namespace DevExpressReports.Reports.Planning.ProcessingPlant.RecievingChickens.PT_DailyProcessing
{
    ...
    " / (Sum([CounterTotal]) + Sum([DOA]) + Sum([Culls])),\n  0\n)\n";
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel2, "ar", "Text", "?????? ????: [TotalNo]"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel3, "ar", "Text", "?????? ??? ??????? : [TotalNo] * sumAvg([TotalDressedWeight])"),
