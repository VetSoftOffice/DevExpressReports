namespace DevExpressReports.Reports.Planning.ProcessingPlant.Summary.DailyReconcilition
{
    partial class DailyReconcilition
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(DailyReconcilition));
            ...
            this.SR_PT_DailyReconcilition_1 = new DevExpress.XtraReports.UI.XRSubreport();
            ...
            this.AvgScaleWeight = new DevExpress.XtraReports.UI.CalculatedField();
            this.PulckRejectPrecent = new DevExpress.XtraReports.UI.CalculatedField();
            this.AvgWeightScale = new DevExpress.XtraReports.UI.CalculatedField();
            this.TotalPluackRejectPercent = new DevExpress.XtraReports.UI.CalculatedField();
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')\n\n"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[AvgScaleWeight]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[PulckRejectPrecent]"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')\n")});
            ...
            this.SR_PT_DailyReconcilition_1});
            this.SubBand6.Name = "SubBand6";
            // 
            // SR_PT_DailyReconcilition_1
            // 
            this.SR_PT_DailyReconcilition_1.Name = "SR_PT_DailyReconcilition_1";
            this.SR_PT_DailyReconcilition_1.ReportSource = new DevExpressReports.Reports.Planning.ProcessingPlant.Summary.DailyReconcilition_SubReport.DailyReconcilition_SubReport();
            // 
            // ReportFooterSub1
            // 
            ...
            new DevExpress.XtraReports.UI.GroupField("ProcessingPlantCode", DevExpress.XtraReports.UI.XRColumnSortOrder.Ascending)});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[ProcessingPlantCode]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')\n\n\n\n"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "sumAvg([rf_Day])")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')\n\n\n"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "sumSum([AvgWeightScale])")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "sumAvg([TotalDressedWeight])"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')\n")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[TotalPluackRejectPercent]"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')\n")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "sumSum([Deviation])"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')\n")});
    ...
    "\n";
            ...
            // AvgScaleWeight
            // 
            this.AvgScaleWeight.DataMember = "SR_PT_DailyReconcilition";
            this.AvgScaleWeight.Expression = "Iif([CounterTotal] > 0,[ScaleWeight] / [CounterTotal] + [Culls] + [DOA], 0 )";
            this.AvgScaleWeight.Name = "AvgScaleWeight";
            // 
            // PulckRejectPrecent
            // 
            this.PulckRejectPrecent.DataMember = "SR_PT_DailyReconcilition";
            this.PulckRejectPrecent.Expression = "Iif([CounterTotal] != 0,[PluckReject]/ [CounterTotal] * 100, 0)";
            this.PulckRejectPrecent.Name = "PulckRejectPrecent";
            // 
            // AvgWeightScale
            // 
            this.AvgWeightScale.DataMember = "SR_PT_DailyReconcilition";
            this.AvgWeightScale.Expression = "Iif(\n  Sum([CounterTotal]) > 0,\n  Sum([ScaleWeight]) / \n  (Sum([CounterTotal]) + " +
    "Sum([Culls]) + Sum([DOA])),\n  0\n)\n";
            this.AvgWeightScale.Name = "AvgWeightScale";
            // 
            // TotalPluackRejectPercent
            // 
            this.TotalPluackRejectPercent.DataMember = "SR_PT_DailyReconcilition";
            this.TotalPluackRejectPercent.Expression = "Iif(\n  Sum([CounterTotal]) <> 0,\n  Sum([PluckReject]) * 100 / Sum([CounterTotal])" +
    ",\n  0\n)\n";
            this.TotalPluackRejectPercent.Name = "TotalPluackRejectPercent";
            // 
            // DailyReconcilition
            // 
            ...
            this.Test,
            this.AvgScaleWeight,
            this.PulckRejectPrecent,
            this.AvgWeightScale,
            this.TotalPluackRejectPercent});
            this.ComponentStorage.AddRange(new System.ComponentModel.IComponent[] {
            this.dsFinance1});
            this.DataMember = "SR_PT_DailyReconcilition";
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.pageInfoCurrentDate, "Default", "SizeF", new System.Drawing.SizeF(201.4167F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.pageInfoPageNoOfTotal, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(938.2082F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.pageInfoPageNoOfTotal, "Default", "SizeF", new System.Drawing.SizeF(210.7886F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.srReportFooterCustom, "Default", "SizeF", new System.Drawing.SizeF(1147.994F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.srReportHeader, "Default", "SizeF", new System.Drawing.SizeF(1147.994F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.SR_PT_DailyReconcilition_1, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(0F, 22.91667F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.SR_PT_DailyReconcilition_1, "Default", "SizeF", new System.Drawing.SizeF(1148.994F, 20F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.SubBand1, "Default", "HeightF", 2.291679F),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.SubBand6, "Default", "HeightF", 42.91668F),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.SubBand7, "Default", "HeightF", 40F),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel1, "Default", "SizeF", new System.Drawing.SizeF(207.4166F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel3, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(1.66893E-06F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel3, "Default", "SizeF", new System.Drawing.SizeF(358.5F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrPanel2, "Default", "SizeF", new System.Drawing.SizeF(1145.997F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTable2, "Default", "SizeF", new System.Drawing.SizeF(1146.997F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTable4, "Default", "SizeF", new System.Drawing.SizeF(1146.997F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTable6, "Default", "SizeF", new System.Drawing.SizeF(1146.997F, 40F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell1, "Default", "Text", "Avg Scale Weight"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell1, "ar", "Text", "متوسط الوزن عند الميزان"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell1, "Default", "Weight", 36.675592661336523D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell10, "Default", "Weight", 0.93111957309989768D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell11, "Default", "Weight", 1.8882472432347928D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell12, "Default", "Weight", 1.8512193251411224D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell13, "Default", "Weight", 1.4573980005918332D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell14, "Default", "Weight", 1.8972098126076644D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell15, "Default", "Weight", 1.1163426742296423D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell16, "Default", "Weight", 0.97170476220230262D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell17, "Default", "Weight", 0.93439246850335633D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell2, "Default", "Text", "DOA"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell2, "ar", "Text", "نافق عند الوصول"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell2, "Default", "Weight", 27.942576937412866D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell24, "Default", "Text", "Avg Dressed Weight"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell24, "ar", "Text", "متوسط وزن الذبيحة"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell24, "Default", "Weight", 39.731846806808591D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell25, "Default", "Weight", 2.304314320620882D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell26, "Default", "Weight", 1.6205714426830555D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell27, "Default", "Weight", 1.7634411374118195D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell28, "Default", "Weight", 2.1271080697257925D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell3, "Default", "Weight", 1.0018501767076791D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell30, "Default", "Weight", 1.1644787120140072D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell31, "Default", "Weight", 0.63001119726765553D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell32, "Default", "Weight", 1.3488595756346975D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell33, "Default", "Weight", 1.7634763366535715D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell35, "Default", "Weight", 0.93111620005906182D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell36, "Default", "Weight", 1.1163547756125696D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell37, "Default", "Weight", 0.9716911671140398D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell38, "Default", "Weight", 0.934393931662784D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell39, "Default", "Weight", 1.1645030005506578D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell40, "Default", "Weight", 2.127055726111192D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell41, "Default", "Weight", 0.6300137877659906D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell42, "Default", "Weight", 1.348865057958659D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell5, "Default", "Weight", 2.3042665346002589D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell56, "Default", "Text", "Culls"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell56, "ar", "Text", "مستبعدات"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell56, "Default", "Weight", 26.150301828133777D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell57, "Default", "Text", "Electric Counter"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell57, "ar", "Text", "عداد الكتروني"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell57, "Default", "Weight", 32.924575924150417D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell58, "Default", "Text", "Pluck Reject"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell58, "ar", "Text", "المرفوض عند النتف"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell58, "Default", "Weight", 31.552757730136122D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell59, "Default", "Text", "Farm"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell59, "ar", "Text", "مزرعة"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell59, "Default", "Weight", 17.274231905663683D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell6, "Default", "Weight", 1.6205688325007483D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell60, "Default", "Text", "House"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell60, "ar", "Text", "عنبر"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell60, "Default", "Weight", 16.054745192209751D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell61, "Default", "Text", "Initial Chicks Placed"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell61, "ar", "Text", "عدد الكتاكيت المسكنة"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell61, "Default", "Weight", 19.248431121065394D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell62, "Default", "Text", "Breed"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell62, "ar", "Text", "السلالة"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell62, "Default", "Weight", 16.754518529476371D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell63, "Default", "Text", "Farm Mort"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell63, "ar", "Text", "نافق المزرعة"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell63, "Default", "Weight", 16.1108389011731D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell64, "Default", "Text", "%"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell64, "Default", "Weight", 25.127555632334307D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell65, "Default", "Text", "Net Chicken"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell65, "ar", "Text", "اجمالي الكتاكيت"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell65, "Default", "Weight", 20.078725557560286D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell66, "Default", "Weight", 10.862911419724028D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell67, "Default", "Text", "Catch Loss"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell67, "ar", "Text", "الفاقد اثناء الجمع"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell67, "Default", "Weight", 23.257579464057748D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell68, "Default", "Text", "Scale Weight"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell68, "ar", "Text", "الوزن عند الميزان"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell68, "Default", "Weight", 30.406557603810292D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell69, "Default", "Text", "Dev."),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell69, "ar", "Text", "الانحراف"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell69, "Default", "Weight", 32.712260891097252D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell7, "Default", "Weight", 1.5166287394649676D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell70, "Default", "Weight", 1.5166279333970953D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell71, "Default", "Weight", 1.9095119324594687D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell72, "Default", "Weight", 1.8299529596260253D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell73, "Default", "Weight", 1.4573099959353655D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell74, "Default", "Weight", 1.8972002034313267D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell8, "Default", "Weight", 1.0018460681494692D),
    ...
    "0\\VetSoftDevExpress.dll";
        ...
        private DevExpress.XtraReports.UI.XRSubreport SR_PT_DailyReconcilition_1;
        ...
        private DevExpress.XtraReports.UI.CalculatedField AvgScaleWeight;
        private DevExpress.XtraReports.UI.CalculatedField PulckRejectPrecent;
        private DevExpress.XtraReports.UI.CalculatedField AvgWeightScale;
        private DevExpress.XtraReports.UI.CalculatedField TotalPluackRejectPercent;
    }
}
