namespace DevExpressReports.Reports.Farms.Layer.ProductionPeriod.Performance.SR_LAY_WeeklyLayFlocks
{
    partial class SR_LAY_WeeklyLayFlocks
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SR_LAY_WeeklyLayFlocks));
            ...
            this.TableEggsPerc = new DevExpress.XtraReports.UI.CalculatedField();
            this.Reject = new DevExpress.XtraReports.UI.CalculatedField();
            this.RejectPerc = new DevExpress.XtraReports.UI.CalculatedField();
            this.ProdPerc = new DevExpress.XtraReports.UI.CalculatedField();
            this.DailyFeedBird = new DevExpress.XtraReports.UI.CalculatedField();
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "Iif(isnull(sumRunningSum([Mort]),0) + IsNull([StartBalance], 0) > 0, (sumRunningS" +
                    "um([Mort])) * 100/ (isnull(sumRunningSum([Mort]),0) + IsNull([StartBalance], 0))" +
                    " , 0)")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[TableEggs]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[TableEggsPerc]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "Iif(IsNull(sumRunningSum([TotalEggs]), 0) > 0,((sumRunningSum([TotalEggs]) - sumR" +
                    "unningSum([TableEggs])) / sumRunningSum([TotalEggs])) * 100, 0)")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[ProdPerc]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "Iif(IsNull([FemalesPOL], 0) > 0,  IsNull([TotalEggs],0) / ToFloat(IsNull([Females" +
                    "POL], 0)), 0)\n")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[EggsHHStd]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[DailyFeedBird]")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL == True, \'MiddleLeft\', \'MiddleRight\')"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "sumRunningSum([DailyFeedBird]) / 1000")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Visible", "Not IsNullOrEmpty([FemalesPOL])")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "?FlockNo")});
            ...
            table1.MetaSerializable = "<Meta X=\"30\" Y=\"30\" Width=\"230\" Height=\"363\" />";
            table1.Name = "SR_LAY_WeeklyLayFlocks";
            ...
            columnExpression6.ColumnName = "ProdWeek";
            ...
            columnExpression10.ColumnName = "TotalEggs";
            columnExpression10.Table = table1;
            column10.Expression = columnExpression10;
            columnExpression11.ColumnName = "TableEggs";
            columnExpression11.Table = table1;
            column11.Expression = columnExpression11;
            columnExpression12.ColumnName = "EggsProdStd";
            columnExpression12.Table = table1;
            column12.Expression = columnExpression12;
            columnExpression13.ColumnName = "FemalesPOL";
            columnExpression13.Table = table1;
            column13.Expression = columnExpression13;
            columnExpression14.ColumnName = "EggsHHStd";
            ...
            selectQuery1.Name = "SR_LAY_WeeklyLayFlocks";
            ...
            // MortPerc
            // 
            this.MortPerc.DataMember = "SR_LAY_WeeklyLayFlocks";
            this.MortPerc.Expression = "iif(IsNull([StartBalance],0) != 0, (IsNull([Mort],0)*100.00) / [StartBalance], 0)" +
    "";
            this.MortPerc.Name = "MortPerc";
            // 
            // TableEggsPerc
            // 
            this.TableEggsPerc.DataMember = "SR_LAY_WeeklyLayFlocks";
            this.TableEggsPerc.Expression = "Iif(IsNull([TotalEggs],0) != 0, (IsNull([TableEggs], 0) * 100.00) / [TotalEggs], " +
    "0)";
            this.TableEggsPerc.Name = "TableEggsPerc";
            // 
            // Reject
            // 
            this.Reject.DataMember = "SR_LAY_WeeklyLayFlocks";
            this.Reject.Expression = "IsNull([TotalEggs],0) - IsNull([TableEggs], 0)";
            this.Reject.Name = "Reject";
            // 
            // RejectPerc
            // 
            this.RejectPerc.DataMember = "SR_LAY_WeeklyLayFlocks";
            this.RejectPerc.Expression = "Iif(IsNull([TotalEggs], 0) != 0, (IsNull([Reject], 0) * 100.00) / IsNull([TotalEg" +
    "gs], 0), 0)";
            this.RejectPerc.Name = "RejectPerc";
            // 
            // ProdPerc
            // 
            this.ProdPerc.DataMember = "SR_LAY_WeeklyLayFlocks";
            this.ProdPerc.Expression = "Iif(IsNull([StartBalance], 0) != 0, ((IsNull([TotalEggs], 0)* 100.00) / [StartBal" +
    "ance]) / 7, 0)";
            this.ProdPerc.Name = "ProdPerc";
            // 
            // DailyFeedBird
            // 
            this.DailyFeedBird.DataMember = "SR_LAY_WeeklyLayFlocks";
            this.DailyFeedBird.Expression = "Iif(IsNull([StartBalance], 0) != 0, IsNull([FeedConsKG], 0) / 7 / IsNull([StartBa" +
    "lance], 0) * 1000, 0)";
            this.DailyFeedBird.Name = "DailyFeedBird";
            // 
            // SR_LAY_WeeklyLayFlocks
            // 
            ...
            this.dslayer});
            this.DataMember = "SR_LAY_WeeklyLayFlocks";
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.GroupHeader1, "Default", "HeightF", 2.291679F),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.GroupHeaderSub4, "Default", "HeightF", 73.12501F),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tdAccount_From, "Default", "Weight", 19.011092552655338D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tdAccount_From, "ar", "Weight", 17.176203487789074D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tdCostCenter, "Default", "Weight", 19.011112804244767D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tdCostCenter, "ar", "Weight", 17.176214069836512D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tdSr, "Default", "Weight", 19.011112922210543D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tdSr, "ar", "Weight", 17.176219022573282D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.thAge, "Default", "Text", "Mort"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.thAge, "ar", "Text", "نافق"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.thAge, "Default", "Weight", 1.4738054377819896D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.thClosing, "Default", "Text", "Start Balance"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.thClosing, "ar", "Text", "الرصيد الإفتتاحي"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.thClosing, "Default", "Weight", 2.292586171438272D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.thCrop, "Default", "Text", "Breed"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.thCrop, "ar", "Text", "سلالة"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.thCrop, "Default", "Weight", 1.9650738714577576D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.tHeader, "Default", "SizeF", new System.Drawing.SizeF(1149F, 73.12501F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.thFarmCode, "Default", "Weight", 1.4738053930317774D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.thFlock, "Default", "Text", "Pord Week"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.thFlock, "ar", "Text", "أسبوع"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.thFlock, "Default", "Weight", 1.4738057549601589D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.thHouse, "Default", "Text", "Age"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.thHouse, "ar", "Text", "العمر"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.thHouse, "Default", "Weight", 1.4738054024486742D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel1, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(777.2668F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel1, "Default", "SizeF", new System.Drawing.SizeF(361.7332F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel15, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(154.7747F, 0F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel16, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(197.0285F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel16, "Default", "SizeF", new System.Drawing.SizeF(86.45834F, 20F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel16, "Default", "Text", "xrLabel4"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel2, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(569.3453F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel2, "Default", "SizeF", new System.Drawing.SizeF(190.6548F, 20F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel2, "Default", "Text", "Female POL: [FemalesPOL!#,#]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel2, "ar", "Text", "عدد الناث عند بداية: [FemalesPOL!#,#]"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel3, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(429.7747F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel3, "Default", "SizeF", new System.Drawing.SizeF(53.36491F, 20F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel3, "Default", "Text", "Crop:"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel3, "ar", "Text", "محصول:"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel4, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(483.1396F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel4, "Default", "SizeF", new System.Drawing.SizeF(68.05554F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel6, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(297.1212F, 0F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel7, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(339.3751F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel7, "Default", "SizeF", new System.Drawing.SizeF(80.20837F, 20F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel7, "Default", "Text", "xrLabel4"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell1, "Default", "Weight", 29.572806284302061D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell1, "ar", "Weight", 26.718518647849073D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell10, "Default", "Text", "Total  Eggs"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell10, "ar", "Text", "إجمالي البيض"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell10, "Default", "Weight", 2.2925862437671523D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell11, "Default", "Text", "Table Eggs \r\n%"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell11, "ar", "Text", "بيض مائدة %"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell11, "Default", "Weight", 1.637561556868995D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell11, "ar", "Weight", 1.8502793287242003D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell12, "Default", "Text", "Eggs \r\nHH \r\nStd"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell12, "ar", "Text", "قياسى عدد البيض لكل دجاجة مسكنة"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell12, "Default", "Weight", 1.73990523168167D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell12, "ar", "Weight", 2.7009275027075543D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell13, "Default", "Text", "Reject"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell13, "ar", "Text", "مرفوض"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell13, "Default", "Weight", 1.6375615877574223D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell13, "ar", "Weight", 3.1130979225891915D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell14, "Default", "Text", "Reject %"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell14, "ar", "Text", "مرفوض %"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell14, "Default", "Weight", 1.6375615534801944D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell14, "ar", "Weight", 2.2924317780071011D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell15, "Default", "Text", "Cum Reject %"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell15, "ar", "Text", "تراكمي المرفوض %"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell15, "Default", "Weight", 1.6375615534801944D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell15, "ar", "Weight", 2.0529263571099858D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell16, "Default", "Text", "Prod %"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell16, "ar", "Text", "الإنتاج %"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell16, "Default", "Weight", 1.6375615534801944D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell16, "ar", "Weight", 1.3627278585036906D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell17, "Default", "Text", "Eggs Prod \r\nStd"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell17, "ar", "Text", "قياسي الإنتاج %"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell17, "Default", "Weight", 1.6375616245044891D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell17, "ar", "Weight", 2.192183740557228D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell18, "Default", "Text", "Egg \r\n/ \r\nHH"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell18, "ar", "Text", "عدد البيض لكل دجاجة مسكنة"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell18, "Default", "Weight", 2.012837423811892D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell18, "ar", "Weight", 1.6182253865368028D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell19, "Default", "Text", "Cum KG Feed/ bird"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell19, "ar", "Text", "تراكمى استهلاك العلف فى اليوم/طائر"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell19, "Default", "Weight", 2.1438376763638938D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell2, "Default", "Text", "Daily(G) Feed / bird"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell2, "ar", "Text", "استهلاك العلف فى اليوم/طائر"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell2, "Default", "Weight", 1.9309593710217212D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell2, "ar", "Weight", 2.3463178136503311D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell20, "Default", "Text", "Mort \r\n%"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell20, "ar", "Text", "نافق%"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell20, "Default", "Weight", 1.4738053753139759D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell21, "Default", "Weight", 21.123438078355065D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell21, "ar", "Weight", 25.548425165010336D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell22, "Default", "Weight", 25.964242867621493D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell22, "ar", "Weight", 18.859319656137252D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell23, "Default", "Weight", 22.443652878074005D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell23, "ar", "Weight", 31.47750145027852D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell24, "Default", "Weight", 24.908071027846308D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell24, "ar", "Weight", 27.344690855987324D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell26, "Default", "Weight", 21.123435964131829D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell26, "ar", "Weight", 36.281074777069463D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell3, "Default", "Weight", 29.572781389768451D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell3, "ar", "Weight", 26.718511480809113D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell30, "Default", "Weight", 21.123435848154514D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell30, "ar", "Weight", 26.716737287815491D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell31, "Default", "Weight", 19.011118761415037D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell31, "ar", "Weight", 17.176207134284127D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell32, "Default", "Weight", 19.01110653839584D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell32, "ar", "Weight", 17.176227143071564D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell33, "Default", "Weight", 19.011093706805866D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell33, "ar", "Weight", 22.457086403080176D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell34, "Default", "Weight", 21.123434932092238D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell34, "ar", "Weight", 23.92546352885957D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell35, "Default", "Weight", 21.123438078355036D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell35, "ar", "Weight", 15.881668002974207D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell36, "Default", "Weight", 27.654029867267653D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell36, "ar", "Weight", 24.984978423538905D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell4, "Default", "Weight", 29.572803210599119D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell4, "ar", "Weight", 26.718518797326791D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell5, "Default", "Weight", 29.572806253391661D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell5, "ar", "Weight", 21.43765941806274D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell53, "Default", "Weight", 25.348126470070746D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell53, "ar", "Weight", 22.901603419341509D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell6, "Default", "Text", "Table Eggs"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell6, "ar", "Text", "بيض مائدة"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell6, "Default", "Weight", 2.2925862452376191D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell7, "Default", "Text", "Cum. Mort\r\n %"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell7, "ar", "Text", "تراكمي نافق%"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell7, "Default", "Weight", 1.4738058911180596D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell7, "ar", "Weight", 1.9269308423050513D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell8, "Default", "Weight", 21.123437124917814D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell8, "ar", "Weight", 21.563749388980341D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell9, "Default", "Text", "End Balance"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell9, "ar", "Text", "الرصيد الختامي"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell9, "Default", "Weight", 2.2925862289835948D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell9, "ar", "Weight", 1.8394612777966031D)});
            this.PageHeight = 827;
            this.PageWidth = 1169;
        ...
        private DevExpress.XtraReports.UI.CalculatedField TableEggsPerc;
        ...
        private DevExpress.XtraReports.UI.CalculatedField ProdPerc;
        private DevExpress.XtraReports.UI.CalculatedField DailyFeedBird;
    }
}
