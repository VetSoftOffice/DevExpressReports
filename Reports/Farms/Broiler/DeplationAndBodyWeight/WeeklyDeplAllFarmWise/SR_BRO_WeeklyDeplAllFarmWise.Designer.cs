namespace DevExpressReports.Reports.Farms.Broiler.DeplationAndBodyWeight.WeeklyDeplAllFarmWise
{
    partial class SR_BRO_WeeklyDeplAllFarmWise
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SR_BRO_WeeklyDeplAllFarmWise));
            ...
            this.sR_BRO_FinalCropReportTableAdapter = new DevExpressReports.Reports.Finance.DataSets.dsFinanceTableAdapters.SR_BRO_FinalCropReportTableAdapter();
            this.CumMortPerc = new DevExpress.XtraReports.UI.CalculatedField();
            this.CumCulssPerc = new DevExpress.XtraReports.UI.CalculatedField();
            this.TotalLosePerc = new DevExpress.XtraReports.UI.CalculatedField();
            this.TotalWeight = new DevExpress.XtraReports.UI.CalculatedField();
            this.Consumption = new DevExpress.XtraReports.UI.CalculatedField();
            this.FCR = new DevExpress.XtraReports.UI.CalculatedField();
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL, \'MiddleRight\', \'MiddleLeft\')")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[TotalLosePerc]"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL, \'MiddleRight\', \'MiddleLeft\')\n\n")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[AvgWt]"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL, \'MiddleRight\', \'MiddleLeft\')\n\n")});
            ...
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "Text", "[AvgWtStd]"),
            new DevExpress.XtraReports.UI.ExpressionBinding("BeforePrint", "TextAlignment", "Iif(?IsRTL, \'MiddleRight\', \'MiddleLeft\')\n\n\n")});
    ...
    "✓\', \n    \'X\')\n";
            ...
            // 
            // sR_BRO_FinalCropReportTableAdapter
            // 
            this.sR_BRO_FinalCropReportTableAdapter.ClearBeforeFill = true;
            // 
            // CumMortPerc
            // 
            this.CumMortPerc.DataMember = "SR_BRO_WeeklyDeplAllFarmWise";
            this.CumMortPerc.Expression = "Iif([StartBirds] <> 0,Floor(Sum([CumMort])) * 100 / Floor([StartBirds]), 0)\n";
            this.CumMortPerc.Name = "CumMortPerc";
            // 
            // CumCulssPerc
            // 
            this.CumCulssPerc.DataMember = "SR_BRO_WeeklyDeplAllFarmWise";
            this.CumCulssPerc.Expression = "Iif([StartBirds] <> 0, Floor(ToDecimal([CumCulls]) * 100 / ToDecimal([StartBirds]" +
    ")), 0)\n";
            this.CumCulssPerc.Name = "CumCulssPerc";
            // 
            // TotalLosePerc
            // 
            this.TotalLosePerc.DataMember = "SR_BRO_WeeklyDeplAllFarmWise";
            this.TotalLosePerc.Expression = "Iif([StartBirds] <> 0, Floor(ToDecimal([CumMortPerc]) + ToDecimal([CumCulssPerc])" +
    "), 0)\n";
            this.TotalLosePerc.Name = "TotalLosePerc";
            // 
            // TotalWeight
            // 
            this.TotalWeight.DataMember = "SR_BRO_WeeklyDeplAllFarmWise";
            this.TotalWeight.Expression = "Round([AvgWt], 1) * ([LiveChicks]) / 1000\n";
            this.TotalWeight.Name = "TotalWeight";
            // 
            // Consumption
            // 
            this.Consumption.DataMember = "SR_BRO_WeeklyDeplAllFarmWise";
            this.Consumption.Expression = "Iif([LiveChicks] <> 0, ToDecimal([RTotalFeedKG]) * 1000 / ToDecimal([LiveChicks])" +
    ", 0)\n";
            this.Consumption.Name = "Consumption";
            // 
            // FCR
            // 
            this.FCR.DataMember = "SR_BRO_WeeklyDeplAllFarmWise";
            this.FCR.Expression = "Iif([TotalWeight] <> 0, Floor(ToDecimal(sum([TotalFeed]))) / Floor(ToDecimal([Tot" +
    "alWeight])), 0)\n";
            this.FCR.Name = "FCR";
            // 
            // BookPerf
            ...
            this.sqlDataSource1,
            this.dsFinance1});
            this.DataMember = "SR_BRO_WeeklyDeplAllFarmWise";
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.pageInfoCurrentDate, "Default", "SizeF", new System.Drawing.SizeF(401.226F, 20F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.pageInfoCurrentTime, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(609.8751F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.pageInfoCurrentTime, "Default", "SizeF", new System.Drawing.SizeF(333.3347F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.pageInfoPageNoOfTotal, "Default", "SizeF", new System.Drawing.SizeF(636.9515F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.srReportFooterCustom, "Default", "SizeF", new System.Drawing.SizeF(1595.993F, 20F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.srReportHeader, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(1.003949F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.srReportHeader, "Default", "SizeF", new System.Drawing.SizeF(1594.996F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.srReportHeaderCustom, "Default", "SizeF", new System.Drawing.SizeF(1596F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.srReportNotes, "Default", "SizeF", new System.Drawing.SizeF(1595.993F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.srReportSignature, "Default", "SizeF", new System.Drawing.SizeF(1595.993F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.srReportSignature_PageFooter, "Default", "SizeF", new System.Drawing.SizeF(1595.993F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrLabel1, "Default", "SizeF", new System.Drawing.SizeF(520.7035F, 23F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTable3, "Default", "LocationFloat", new DevExpress.Utils.PointFloat(161.1178F, 0F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTable3, "Default", "SizeF", new System.Drawing.SizeF(1434.882F, 39.99999F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTable4, "Default", "SizeF", new System.Drawing.SizeF(1595F, 20F)),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTable6, "Default", "SizeF", new System.Drawing.SizeF(160.118F, 39.99998F)),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell1, "Default", "Text", "Avg Wt Std (g)\n"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell1, "ar", "Text", "ق. متوسط الوزن جم\n"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell10, "ar", "Text", "تراكمي قرزة %"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell10, "Default", "Weight", 1D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell11, "Default", "Text", "Total Lose %\n"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell11, "ar", "Text", "اجمالي الفقد %"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell11, "Default", "Weight", 1D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell12, "Default", "Text", "Chicks At End Of Week\n"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell12, "ar", "Text", "الكتاكيت في نهاية الاسبوع"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell13, "Default", "Weight", 2.7625438573026431D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell14, "Default", "Text", "Avg Wt (g)\n"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell14, "ar", "Text", "متوسط الوزن جم.\n"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell15, "Default", "Weight", 1.6160379930560227D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell16, "Default", "Weight", 2.1148267950939585D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell17, "Default", "Weight", 3.4369341716915711D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell18, "Default", "Weight", 2.7625496013546238D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell19, "Default", "TextFormatString", "{0:N4}"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell19, "Default", "Weight", 2.7625496013546238D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell2, "Default", "Text", "Total Feed (KG)\n"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell2, "ar", "Text", "اجمالي العلف كجم\n"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell2, "Default", "Weight", 1D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell24, "Default", "Text", "Total Weight (KG)\n"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell24, "ar", "Text", "اجمالي الوزن كجم\n"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell24, "Default", "Weight", 1D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell3, "Default", "Text", "Consumption / Bird (g)\n"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell3, "ar", "Text", "العلف بالجرام / طائر\n"),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell30, "Default", "Weight", 2.762546218641261D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell31, "Default", "Weight", 2.7625441828914328D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell32, "Default", "Weight", 2.7625455234086091D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell33, "Default", "Weight", 2.7625522153639146D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell40, "Default", "Weight", 2.7625388814014311D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell5, "Default", "Text", "Crop No\n"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell5, "ar", "Text", "محصول"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell5, "Default", "Weight", 0.76553564289185916D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell55, "Default", "TextFormatString", "{0:N1}"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell55, "Default", "Weight", 2.7625453229987933D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell56, "Default", "Weight", 2.7625496013546238D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell59, "Default", "Text", "Cycle No\n"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell59, "ar", "Text", "دورة"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell59, "Default", "Weight", 9.0043457743576063D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell6, "Default", "Text", "Age (Days)\n"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell6, "ar", "Text", "العمر بالايام"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell6, "Default", "Weight", 1.244118878909914D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell63, "Default", "Text", "Farm\n"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell63, "ar", "Text", "مزرعة"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell63, "Default", "Weight", 6.9750755978943D),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell8, "Default", "Weight", 2.0861955701965105D),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell9, "Default", "Text", "FCR"),
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableCell9, "ar", "Text", "م.ت.ع."),
            ...
            new DevExpress.XtraReports.Localization.LocalizationItem(this.xrTableRow5, "Default", "Weight", 1.9999990463256836D)});
            this.Padding = new DevExpress.XtraPrinting.PaddingInfo(2F, 2F, 0F, 0F, 100F);
            this.PageHeightF = 827F;
            this.PageWidthF = 1606F;
    ...
    "0\\VetSoftDevExpress.dll";
        ...
        private Reports.Finance.DataSets.dsFinanceTableAdapters.SR_BRO_FinalCropReportTableAdapter sR_BRO_FinalCropReportTableAdapter;
        ...
        private DevExpress.XtraReports.UI.CalculatedField CumCulssPerc;
        private DevExpress.XtraReports.UI.CalculatedField TotalLosePerc;
        private DevExpress.XtraReports.UI.CalculatedField TotalWeight;
        private DevExpress.XtraReports.UI.CalculatedField Consumption;
        private DevExpress.XtraReports.UI.CalculatedField FCR;
